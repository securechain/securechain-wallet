...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SecureCoin securecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  securecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded securecoin transaction") + "\n" +
              "  securecoin-tx [options] -create [commands]   " + _("Create hex-encoded securecoin transaction") + "\n" +
              "\n";
