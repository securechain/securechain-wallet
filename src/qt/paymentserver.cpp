...
const char* BITCOIN_REQUEST_MIMETYPE = "application/securecoin-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/securecoin-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/securecoin-payment";
...
{
    QString name("SecurechainWallet");
...
//
// OSX-specific way of handling securecoin: URIs and
// PaymentRequest mime types
//
bool PaymentServer::eventFilter(QObject *object, QEvent *event)
{
    // clicking on securecoin: URIs creates FileOpen events on the Mac
