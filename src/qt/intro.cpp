...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Securechain Wallet"),
     ...
     * override -datadir in the securecoin.conf file in the default data directory
     * (to be consistent with securecoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
