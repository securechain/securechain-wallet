...
{
    /* A sanity check was added in pull #3843 (for bitcoin) to avoid adding
     * redeemScripts that never can be redeemed. However, old wallets may
     * still contain these. Do not add them to the wallet and warn. */
