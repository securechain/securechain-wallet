...
{
    // Random real transaction (06e693f613ea0a50a9143a70b7ce39cf38fc156aad3e908c7a8916d8a0a29d84)
    CTransaction tx;
    CDataStream stream(ParseHex(""), SER_DISK, CLIENT_VERSION);
    stream >> tx;
...
//    spendStream >> spendingTx;
    ...
    filter.insert(uint256("0x06e693f613ea0a50a9143a70b7ce39cf38fc156aad3e908c7a8916d8a0a29d84"));
    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match tx hash");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    // byte-reversed tx hash
    filter.insert(ParseHex("849da2a0d816897a8c903ead6a15fc38cf39ceb7703a14a9500aea13f693e606"));
    ...
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(ParseHex("3044022021524c5926c28efc1032c05d847a3d68b4e7d79eca29c447d54d29e7ad53f64802207de4e1724a1d92a76ecde1b24fbfb80891cb500e9b8d6a39cfd11efe2ce9450a01"));
    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match input signature");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(ParseHex("0310a4d8c7534cb503e7ec86775c98d44c878f1e14e05b9eb642e4c2f563b7a231"));
    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match input pub key");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(ParseHex("5f9344ec84883fb24ded9fe0ca62c3d64f299856"));
...
//    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(spendingTx, spendingTx.GetHash()), "Simple Bloom filter didn't add output");
    ...
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(ParseHex("572c89572ea225b11c56a676300419599f317fde"));
    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match output address");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(COutPoint(uint256("0x4637b644be90ce73e65354047ca7f621a01143d2a1a15faca8880cdbe9518a74"), 0));
    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match COutPoint");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    COutPoint prevOutPoint(uint256("0x4637b644be90ce73e65354047ca7f621a01143d2a1a15faca8880cdbe9518a74"), 0);
    {
    ...
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(COutPoint(uint256("0x4637b644be90ce73e65354047ca7f621a01143d2a1a15faca8880cdbe9518a74"), 1));
    ...
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(COutPoint(uint256("0x00000044be90ce73e65354047ca7f621a01143d2a1a15faca8880cdbe9518a74"), 0));
    BOOST_CHECK_MESSAGE(!filter.IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter matched COutPoint for an output we didn't care about");
}
