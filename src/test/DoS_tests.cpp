...
BOOST_AUTO_TEST_CASE(DoS_checknbits)
{
    ...
    BOOST_CHECK(!CheckNBits(firstcheck.second, lastcheck.first+60, lastcheck.second, lastcheck.first));
    BOOST_CHECK(!CheckNBits(firstcheck.second, lastcheck.first+60*500, lastcheck.second, lastcheck.first));
