...
{
    LogPrintf("SecureCoinMiner started\n");
    ...
    try { while (true) {
        ...
        LogPrintf("Running SecureCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("SecureCoinnMiner terminated\n");
        throw;
    }
}
