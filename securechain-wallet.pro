...
OPENSSL_INCLUDE_PATH = D:\deps\openssl-1.0.2f\include
OPENSSL_LIB_PATH = D:\deps\openssl-1.0.2f
...
!win32 {
    ...
    genleveldb.commands = cd $$PWD/src/leveldb && $(MAKE) clean && CC=$$QMAKE_CC CXX=$$QMAKE_CXX $(MAKE) OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" libleveldb.a libmemenv.a
} else {
